...
#ifndef BENCHMARK_BENCHMARK_MINIMAL_H_
#define BENCHMARK_BENCHMARK_MINIMAL_H_
...
class State {
 ...
 private:
  ...
  friend class internal::BenchmarkImp;
...
#endif  // BENCHMARK_BENCHMARK_MINIMAL_H_
